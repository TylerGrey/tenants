...
func ApiSchemaQueryGraphql() (*asset, error) {
	...
	info := bindataFileInfo{name: "../api/schema/query.graphql", size: 300, mode: os.FileMode(420), modTime: time.Unix(1590754606, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
